         ...
         <div class="item-container">    
            <div class="container"> 
                ...
                <span class="top-breadcrumb">
                    <a href="<?php echo $this->Html->url(array('controller' => 'Packages', 'action' => 'index'))?>"  class="back-page">
                    ...
                    ?>
                         <div class="col-md-7 -12 col-sm-12">
                            ...
                            <div class="product-info">
                                <div class="head"><span class="brand-name"><?php echo h($product['Package']['name']); ?></span>
                                </div>
                                <!-- div class="items-stock">
                                 ...
                                 <div class="item-price">
                                    <?php if ($product['Package']['show_amount'] != $product['Package']['amount']) { ?>
                                        ...
                                        </strike><?php } ?> <span class="price-actual"><?php echo $currency . $product['Package']['count'] * $product['Package']['amount']; ?></span>
                         ...
                         <div class="col-md-5 viewbag-minicart col-sm-12">
                            <div class="left">
                                ...
                                <div class="view-bag">
                                    <a class="btn btn-primary" href="<?php echo $this->Html->url(array('controller' => 'Carts', 'action' => 'View')) ?>">View Cart</a>
                                </div>
                             </div>
                         </div>
