...
<?php $examId=$post['Exam']['id'];echo $this->Form->create('Exam', array('controller'=>'Exams','action' =>"start/$examId/1",'name'=>'post_req','id'=>'post_req'));?>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<?php if($post['Exam']['multi_language']==1){?>
				<div class="mrg"><strong><?php echo __('View In');?>:</strong><?php echo$this->Form->select('lang',$language,array('id'=>'lang','empty'=>false));?></strong></div>
			<?php }else{
