<style type="text/css">
	...
	.optionSerial{float: left;margin-top: 2px; max-width: 88%}
	i.material-icons.clear{color: red;font-size: 17px;}
	i.material-icons.check {color: #26ce26;font-size: 17px;}
	.tab-content {color: #191919;}
	p {overflow: hidden;margin-bottom: 5px;}
	.subjectNamecls{color: #fff;}
	.subjecthed{text-decoration: none;}
		...
		<div class="tab-pane active" id="solution">
					...
					<div class="">
						<table id="cart" class="table table-condensed">
							...
							<tr>
								...
								<?php if($ques['ExamStat']['ques_status']==NULL && !$ques['ExamStat']['answer'])echo'<div style="border: 1px solid;padding: 15px 15px;width: 100%;"><strong class="">'.__('Not Attempted').'</strong></div>';else echo'<div style="border: 1px solid;padding: 15px 15px;width: 100%;"><span class="">'.__('Attempt').'</span></div>';?></strong></td>
			...
			<div class="col-sm-3">
				<div class="panel-group" style="overflow: hidden;padding: 10px;box-shadow: 0px 2px 5px #888888;" id="accordion">
					...
					<div class="panel panel-default">
						<div class="panel-heading" style="background: #08BBE2;color: #fff;">
						<a data-toggle="collapse" class="subjecthed" data-parent="#accordion" href="#<?php echo$subjectNameId;?>"><h4 class="panel-title subjectNamecls"><?php echo h($subjectName);?></h4></a>
						</div>
			...
			<div class="com-md-12 col-sm-12 col-xs-12">
				...
				<div id="comppanel<?php echo$k;?>" class="compare">
					<div class="col-md-3">
						...
						<div class="col-md-3"><?php if($k<$compareCount){echo$this->Form->button(__('Next'),array('onClick'=>"callCompareNext($k);",'class'=>'btn btn-sm btn-primary'));}?></div>
