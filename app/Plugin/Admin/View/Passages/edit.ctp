    ...
    <div class="panel panel-custom mrg">
        ...
        <div class="panel">
            <div class="panel-body"><?php echo $this->Session->flash(); ?>
                <?php echo $this->Form->create('Passage', array('controller' => 'Passages', 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
                <?php foreach ($Passage as $k => $post):
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php $passageArr=explode("%^&",$post['Passage']['passage']);  foreach ($language as $languageIndex=>$item) {
