...
<div class="panel-heading"><?php echo __('Edit Question Languages');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>
<div class="panel">   
                <div class="panel-body"><?php echo $this->Session->flash();?>
					<?php echo $this->Form->create('Language', array( 'controller' => 'Languages','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
					<?php foreach ($Language as $k=>$post): $id=$post['Language']['id'];$form_no=$k+1;?>
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<label for="group_name" class="col-sm-3 control-label"><?php echo __('False');?></label>
									<div class="col-sm-9">
