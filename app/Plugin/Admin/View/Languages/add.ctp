...
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Add Question Language');?></h1></div></div>
<div class="panel">   
                <div class="panel-body"><?php echo $this->Session->flash();?>
                <?php echo $this->Form->create('Language', array( 'controller' => 'helpcontent','class'=>'form-horizontal'));?>
		    ...
		    <div class="form-group">
                        <label for="group_name" class="col-sm-3 control-label"><small><?php echo __('True');?></small></label>
                        <div class="col-sm-9">
                           <?php echo $this->Form->input('value1',array('label' => false,'class'=>'form-control','placeholder'=>__('Language True'),'div'=>false));?>
                        </div>
                    </div>
		    <div class="form-group">
                        <label for="group_name" class="col-sm-3 control-label"><small><?php echo __('False');?></small></label>
                        <div class="col-sm-9">
