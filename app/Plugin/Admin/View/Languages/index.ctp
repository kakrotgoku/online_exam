...
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Question Languages');?></h1></div></div>
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Languages')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Question Language'),array('controller'=>'Languages','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="panel-body">
			    ...
			    <?php if($id!=1){?><li><?php echo $this->Html->Link('<span class="fa fa-trash"></span>&nbsp;'.__('Delete'),'javascript:void(0);',array('onclick'=>"check_perform_sdelete('$id');",'escape'=>false));?></li><?php }?>
			    </ul>
			    </div></td>
                        </tr>
                        <?php endforeach; ?>
