    ...
    <div class="panel panel-custom mrg">
        ...
        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <?php echo $this->Form->input("$k.Package.expiry_days", array('label' => false, 'class' => 'form-control', 'placeholder' => __('0 for unlimited days'), 'div' => false)); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="subject_name" class="col-sm-3 control-label">
