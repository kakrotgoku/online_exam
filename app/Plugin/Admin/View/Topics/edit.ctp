<div <?php if(!$isError){?>class="container"<?php }?>>    
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Topics');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>
        <div class="panel-body"><?php echo $this->Session->flash();?>
	    <?php echo $this->Form->create('Topic',array('class'=>'form-horizontal'));?>
	    <?php foreach ($Topic as $k=>$post): $id=$post['Topic']['id'];$form_no=$k+1;?>
		...
		<div class="form-group">
		    ...
		    <div class="form-group">
			<label for="group_name" class="col-sm-3 control-label"><?php echo __('Topic Name');?></label>
			<div class="col-sm-9">
