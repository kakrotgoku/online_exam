                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($Coupon as $post):
                        ...
                        <tr>
                            ...
                            <td><?php echo $post['Coupon']['amount']; if($post['Coupon']['discount_type']=="Percent"){echo '%';}?></td>
                            <td><?php echo $post['Coupon']['min_amount']; ?></td>
                            <td><?php echo $post['Coupon']['code']; ?></td>
                            <td><?php if($post['Coupon']['coupon_no']){echo $post['Coupon']['coupon_no']; }else{echo __('Unlimited');}?></td>
                            <td><?php if($post['Coupon']['per_customer']){echo $post['Coupon']['per_customer']; }else{echo __('Unlimited');}?></td>
                            <td><?php echo $this->Time->format($dtFormat,$post['Coupon']['start_date']);?> <br> <?php echo __('to');?> <br><?php echo$this->Time->format($dtFormat,$post['Coupon']['end_date']);?></td>
                            <td><span
