...
<div class="panel-body">
			    ...
			    <th><?php echo $this->Paginator->sort('name', __('Name'), array('direction' => 'asc'));?></th>
                        ...
                        <tr>
                            ...
                            <td  <?php echo($post['Student']['reg_status']=="Live") ? "class=\"danger\"" : "";?>><?php echo $post['Student']['email']; ?><?php if($post['Student']['reg_status']=="Live"){?><br><?php echo $post['Student']['reg_code'];}?></td>
