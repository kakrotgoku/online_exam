					...
					<?php foreach ($Slide as $k=>$post): $id=$post['Slide']['id'];$form_no=$k+1;?>
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group">
                        <label for="group_name" class="col-sm-3 control-label"><small><?php echo __('Heading');?></small></label>
                        <div class="col-sm-9">
                           <?php echo $this->Form->input("$k.Slide.heading",array('label' => false,'class'=>'form-control','placeholder'=>__('Heading'),'div'=>false));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="group_name" class="col-sm-3 control-label"><small><?php echo __('Content');?></small></label>
                        <div class="col-sm-9">
                         <?php echo $this->Tinymce->input("$k.Slide.content", array('value'=>$post['Slide']['content'],'label' => false, 'placeholder' => __('Content', $language), 'class' => 'form-control'), array('language' => $configLanguage, 'directionality' => $dirType), 'full'); ?>
                        </div>
                    </div>
								<div class="form-group">
