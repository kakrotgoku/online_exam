<div class="panel panel-custom">
    ...
    <div class="panel-body"><?php echo $this->Session->flash();?>
        ...
        <div class="form-group">
            <label for="group_name" class="col-sm-3 control-label"><small><?php echo __('Topic');?></small></label>
            <div class="col-sm-9">
               <?php echo $this->Form->select('topic_id',$topic,array('id'=>'topicId','required'=>true,'empty'=>'Please Select','class'=>'form-control','div'=>false));?>
            </div>
        </div>
        <div class="form-group">
            <label for="group_name" class="col-sm-3 control-label"><small><?php echo __('Sub Topic Name');?></small></label>
            <div class="col-sm-9">
