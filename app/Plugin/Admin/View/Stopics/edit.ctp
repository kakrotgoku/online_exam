<div <?php if(!$isError){?>class="container"<?php }?>>    
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Sub Topics');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>
        <div class="panel-body"><?php echo $this->Session->flash();?>
	    <?php echo $this->Form->create('Stopic',array('class'=>'form-horizontal'));?>
	    <?php  foreach ($Stopic as $k=>$post): $id=$post['Stopic']['id'];$form_no=$k;$seltopic="topic$k";?>
		...
		<div class="panel-body">
		    ...
		    <div class="form-group">
			<label for="group_name" class="col-sm-3 control-label"><?php echo __('Sub Topic Name');?></label>
			<div class="col-sm-9">
